...
class SeniorReservationList extends Component {
    ...
    render() {
        ...
        const columns = [
            ...
            {
                title: 'Login wolontariusza wykonującego usługi',
                dataIndex: 'volunteer',
                key: 'volunteer',
                width: '25%',
                render: (volunteer) => <div>{volunteer.login}</div>
...
export default connect( mapStateToProps, mapDispatchToProps )( SeniorReservationList );
